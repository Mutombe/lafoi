...
COMPANY = {
    ...
    "address": config("COMPANY_ADDRESS", default="Suite 26, 6 Chelmsford, Belgravia, Harare, Zimbabwe"),
    "phone_primary": config("COMPANY_PHONE_PRIMARY", default="+263 782 931 472"),
    "phone_secondary": config("COMPANY_PHONE_SECONDARY", default="+263 712 326 951"),
    "email": config("COMPANY_EMAIL", default="admin@lafoidesigns.co.zw"),
    "website": config("COMPANY_WEBSITE", default="www.lafoidesigns.com"),
    "color_green": "#1A8A2E",
