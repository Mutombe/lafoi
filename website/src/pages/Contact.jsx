...
export default function Contact() {
  useSEO({
    ...
    description:
      'Talk to La Foi Designs about stretch ceilings, architectural lighting, interior design in Harare and across Zimbabwe. +263 782 931 472 · admin@lafoidesigns.co.zw',
    path: '/contact',
