      ...
      <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <AnimatedSection delay={0.15}>
          <div className="mb-6 lg:mb-8">
            <div className="relative flex items-center gap-3 px-5 lg:px-6 py-4 rounded-sm bg-white/70 backdrop-blur-xl border border-white/40 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] focus-within:border-lafoi-green/40 focus-within:shadow-[0_8px_32px_-8px_rgba(34,197,94,0.18)] transition-all duration-500">
              ...
              <div className="lg:col-span-7">
                ...
                <div className="flex flex-wrap items-center gap-4 lg:gap-5">
                  <a
                    ...
                    className="group inline-flex items-center gap-3 px-7 py-4 rounded-sm bg-lafoi-green-light text-white font-sora text-sm font-semibold hover:bg-lafoi-green transition-all duration-500 shadow-[0_10px_40px_-10px_rgba(34,197,94,0.55)]"
                  >
                  ...
                  <a
                    ...
                    className="group inline-flex items-center gap-3 px-7 py-4 rounded-sm bg-white/70 backdrop-blur-md border border-lafoi-dark/15 text-lafoi-dark font-sora text-sm font-semibold hover:bg-white hover:border-lafoi-green/40 transition-all duration-500"
                  >
