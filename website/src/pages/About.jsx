        ...
        <div className="relative bg-lafoi-dark order-2 lg:order-1">
          ...
          <div className="relative h-full p-8 lg:p-16 xl:p-24 flex flex-col justify-center">
            ...
            <AnimatedSection delay={0.32}>
              <div className="mt-10 relative rounded-sm bg-white/[0.04] backdrop-blur-sm border border-lafoi-green-light/25 overflow-hidden max-w-lg">
                <span
                  aria-hidden
                ...
                <div className="p-6 lg:p-7">
                  ...
                  <a
                    ...
                    rel="noopener"
                    download
                    className="group inline-flex items-center gap-2.5 px-5 py-3 rounded-sm bg-lafoi-green-light text-lafoi-dark font-sora text-sm font-semibold hover:bg-white transition-all duration-300 shadow-[0_8px_24px_-8px_rgba(34,197,94,0.45)]"
                  >
...
function Values() {
  const values = [
    ...
    },
    {
      ...
      image: '/brand/images/artprint2.png',
      vision: 'Custom photographic sky-print stretch ceiling glowing over a modern reception',
      icon: Lightbulb,
      feature: true,
    },
    {
  ...
  return (
    <div
      className={`relative h-full overflow-hidden bg-lafoi-dark ${
        wide ? 'aspect-[16/6] rounded-sm' : 'min-h-[420px] rounded-sm'
      }`}
    >
      <OptimizedImage
        src={v.image}
...
function PartnerCard({ p }) {
  return (
    <div className="relative h-full p-8 lg:p-10 rounded-sm border border-lafoi-dark/10 bg-white overflow-hidden hover:border-lafoi-green/30 transition-colors duration-500">
      {p.pattern && (
      ...
      <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <AnimatedSection direction="right" className="lg:col-span-6 relative">
            <div className="relative aspect-[4/5] rounded-sm overflow-hidden border border-white/10 bg-lafoi-green">
