  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="hidden lg:block fixed top-1/4 right-3 z-[105] h-1/2 w-[2px] pointer-events-none">
        <div className="absolute inset-0 bg-lafoi-dark/[0.06] rounded-sm" />
        <div
          className="absolute left-0 right-0 top-0 bg-lafoi-green/40 rounded-sm transition-all duration-150"
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 bg-lafoi-dark text-white text-xs font-sora font-medium rounded-sm hover:bg-lafoi-green transition-colors"
                    >
                      Accept All
                    </button>
                    <button
                      onClick={() => { setCookieVisible(false); localStorage.setItem('lafoi-cookies', 'essential') }}
                      className="px-4 py-2 bg-gray-100 text-lafoi-gray text-xs font-sora font-medium rounded-sm hover:bg-gray-200 transition-colors"
                    >
                      Essential Only
                    </button>
                  </div>
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <motion.div
            className="relative w-full max-w-2xl max-h-[80vh] bg-white rounded-sm shadow-2xl overflow-hidden"
          ...
          >
            <div className="sticky top-0 flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100 z-10">
              ...
              <button onClick={onClose} className="p-2 rounded-sm hover:bg-gray-100 transition-colors">
                <X size={18} />
              </button>
            </div>
...
function TermsContent() {
  return (
    <div className="space-y-4 text-sm text-lafoi-gray leading-relaxed">
      ...
      <p>All stretch ceiling installations are covered by a comprehensive manufacturer warranty (up to 10 years on the membrane) plus a workmanship cover from La Foi Designs. Warranty terms vary by product and will be specified in your project agreement.</p>
