          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-lafoi-dark/[0.07]">
              <div className="flex items-center gap-3">
                ...
                {count > 0 && (
                  <span className="inline-flex items-center justify-center min-w-[22px] h-[22px] px-1.5 rounded-sm bg-lafoi-green text-white text-[11px] font-sora font-semibold">
                    {count}
                  </span>
                )}
              </div>
              <button
                onClick={closeCart}
                className="p-2 rounded-sm hover:bg-lafoi-dark/[0.05] transition-colors"
              ...
              <>
                ...
                <div className="border-t border-lafoi-dark/[0.07] px-6 py-5 bg-white/40">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 px-5 py-3.5 bg-[#25D366] hover:bg-[#1DA851] text-white rounded-sm font-sora text-sm font-medium transition-colors duration-300 shadow-lg shadow-[#25D366]/25 group"
                  >
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
      ...
      <Link
        to="/shop"
        onClick={onClose}
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-lafoi-dark text-white rounded-sm font-sora text-sm font-medium hover:bg-lafoi-green transition-colors group"
      >
        Browse the shop
        <ArrowRight
          size={14}
...
function CartItem({ item, onUpdate, onRemove }) {
  return (
    <div className="flex gap-4 group">
      <div className="w-[72px] h-[72px] rounded-sm overflow-hidden bg-lafoi-dark/[0.04] shrink-0">
        <img
          src={item.image}
          alt={item.name}
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            ...
            className="p-1.5 rounded-sm text-lafoi-gray-medium hover:text-red-500 hover:bg-red-50 transition-colors shrink-0"
        ...
        <div className="flex items-center justify-between mt-2.5">
          <div className="inline-flex items-center bg-white border border-lafoi-dark/[0.08] rounded-sm">
            <button
